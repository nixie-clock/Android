...
public class NixieClock extends Activity {
    ...
    public void onStart(){
        super.onStart();
        SharedPreferences prefsM = PreferenceManager.getDefaultSharedPreferences(getBaseContext());
        ...
        if(prefsM.getBoolean("timer_to_end", false) == true){
            timerToM = Integer.parseInt(tiToA[0])*3600+Integer.parseInt(tiToA[1])*60;
        }
        ...
        //Image view arrays
        final ImageView[] face_img_hou = {
            (ImageView)findViewById(R.id.bh1),
            (ImageView)findViewById(R.id.bh2),
            (ImageView)findViewById(R.id.bh3),
            (ImageView)findViewById(R.id.bh4),
            (ImageView)findViewById(R.id.bh5),
            (ImageView)findViewById(R.id.bh6)
        };

        final ImageView[] face_img_min = {
            (ImageView)findViewById(R.id.bm1),
            (ImageView)findViewById(R.id.bm2),
            (ImageView)findViewById(R.id.bm3),
            (ImageView)findViewById(R.id.bm4),
            (ImageView)findViewById(R.id.bm5),
            (ImageView)findViewById(R.id.bm6)
        };

        final ImageView[] face_img_sec = {
            (ImageView)findViewById(R.id.bs1),
            (ImageView)findViewById(R.id.bs2),
            (ImageView)findViewById(R.id.bs3),
            (ImageView)findViewById(R.id.bs4),
            (ImageView)findViewById(R.id.bs5),
            (ImageView)findViewById(R.id.bs6)
        };
            ...
            public void run(){
                ...
                runOnUiThread(new Runnable(){
                    public void run(){
                        ...
                        if(timerEn == true && in == 0){
                            Toast.makeText(getBaseContext(), getString(R.string.alert_timer_done), Toast.LENGTH_LONG).show();
                        }
